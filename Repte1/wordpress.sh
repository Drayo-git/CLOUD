...
echo "Database Name: " $db_name >> output_data.txt
echo "Database User: " $db_user >> output_data.txt
echo "Database Password: " $db_password >> output_data.txt
echo "Mysql root password: " $mysqlrootpass >> output_data.txt
